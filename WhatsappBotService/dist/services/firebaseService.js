...
export const getUserSettings = async (vehicleId) => {
    try {
        ...
        console.log('Error retrieving user settings status from firebase RTDB', e);
    }
};
...
const initializeSettings = async (vehicleId) => {
...
export const setNotifInterval = async (vehicleId, interval) => {
    try {
...
export const setNotify = async (vehicleId, action) => {
    try {
...
export const setSecurityMode = async (vehicleId, action) => {
    try {
...
export const setSwitch = async (vehicleId, action) => {
    try {
...
export const getUserVehicleId = async (jid) => {
    const number = jid.split('@')[0];
